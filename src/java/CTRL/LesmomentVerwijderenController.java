 ...
 * @author Wim
 */
public class LesmomentVerwijderenController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Lesmoment lesmoment = LesmomentServices.getLesmoment(Integer.parseInt(request.getParameter("id")));        
        Module module = lesmoment.getModule();
